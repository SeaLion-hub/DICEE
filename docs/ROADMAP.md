...
| [decisions/](decisions/) | ADR (Architecture Decision Record). 예: [데이터베이스 명세서 v7.0](decisions/database-spec.md), [AI 추출 스키마](decisions/ai-extraction-schema.md), [유저–공지 매칭·API 계약](decisions/user-notice-matching-and-api-contracts.md) (APPROVED). |
