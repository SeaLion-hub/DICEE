...
def test_generated_plan_eng_review_skill_present() -> None:
    skill_md = GENERATED / "gstack-plan-eng-review" / "SKILL.md"
    assert skill_md.is_file(), "Expected gstack-plan-eng-review skill to be generated by ./setup --host codex"


def test_generated_plan_eng_review_skill_md_readable() -> None:
    skill_md = GENERATED / "gstack-plan-eng-review" / "SKILL.md"
    text = skill_md.read_text(encoding="utf-8", errors="replace")
    assert len(text) >= 2048, "Generated gstack-plan-eng-review SKILL.md too small; run ./setup --host codex"
